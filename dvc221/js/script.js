...
//						d3.select("#btn-primary2").style("color"  , "black" ).style("background-color" , "#e7e7e7" ).style("border-color" , "#cccccc" );
						...
						dvc.currentYear = 2017; // this very current years. Needs to be updated accordingly to maintain currency of interative
						...
						*/
						function calculateEXProbs()
						{
							...
							d3.select("#LE").html( dvc.LE + "<span id='peryear'> years </span>");
...
*/							
								d3.select("#actualDiv").attr("class" , "labels col-sm-4 col-xs-12 show");
								d3.select("#actualDiv2").attr("class" , "labels col-sm-4 col-xs-4 show");
								d3.select("#natDiv").attr("class" , "labels col-sm-4 col-xs-12 show");	
								d3.select("#natDiv2").attr("class" , "labels col-sm-4 col-xs-4 show");								
								d3.select("#guessDiv").attr("class" , "labels col-sm-4 col-xs-12 show");							
								d3.select("#guessDiv2").attr("class" , "labels col-sm-4 col-xs-4 show");
...
//							
						...
						svgDocP.append('text').attr("class","graphSubText legendHide")
							...
							.attr("y" , y(dvc.SPAProb[0]) + 25 )
							.style( "text-anchor" , "middle" )
							.tspans(['State', 'pension', 'age'], 20);
							
						d3.select("#idYourSPA").selectAll("tspan").attr("x",x(dvc.SPAtoUse) )
...
//						.html("Your life expectancy");
					...
					svgDocP.append('text').attr("class","graphSubText legendHide")
						...
						.attr("y" , -5 )
						.style( "text-anchor" , "middle" )
						.tspans(['Your', 'life', 'expectancy'], 20);
							
					d3.select("#idYourLE").selectAll("tspan").attr("x",x(dvc.LE))
